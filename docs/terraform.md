...
| <a name="input_enable_registry_replication"></a> [enable\_registry\_replication](#input\_enable\_registry\_replication) | Set to 'true' to enable registry replication | `bool` | `false` | no |
...
| <a name="input_replication_configuration_rules"></a> [replication\_configuration\_rules](#input\_replication\_configuration\_rules) | The replication rules for a replication configuration. A maximum of 10 are allowed per | `any` | `[]` | no |
